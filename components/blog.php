<script type="text/x-template" id="blog">
    <div>
            ...
            <label for="">Kod</label>
            <br>
            <textarea type="text" cols="100" v-model="editedone.tekst"></textarea>
            <br>
...
<script>
    Vue.component('blog', {
        ...
        methods: {
            ...
            add(){
                let self = this;
                axios.post('api/add.php',{tabela:'blog',dane:this.editedone}).then((res)=>{self.editedone = {};self.getData()})
            },
            update() {
